...
pub use owner::{AttestTracker, ShareAction, DEFAULT_ATTEST_INTERVAL_SECS, DEFAULT_FRESHNESS_SECS, DEFAULT_SLACK};
...
impl Cadence {
    ...
    pub fn due(&self, now: u64) -> bool {
        self.last.is_none_or(|last| now.saturating_sub(last) >= self.interval)
    }
